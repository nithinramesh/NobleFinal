...
namespace Noble.Invoice
{
    public partial class AddProducts : System.Web.UI.UserControl
    {
        ...
        InvoiceController quotAccessObj = null;
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
           // Page.Validate();
            if (Page.IsValid)
            {
                if (ddlProd1.SelectedIndex > 0 && Convert.ToInt16(txtQty1.Text) > 0)
                {
                    DataRow newRow = InvoiceController.myDataTable.NewRow();

                    newRow["ID"] = InvoiceController.myDataTable.Rows.Count + 1;
                    ...
                    InvoiceController.myDataTable.Rows.Add(newRow);
