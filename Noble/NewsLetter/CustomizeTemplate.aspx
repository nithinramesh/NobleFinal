<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Site.Master" Inherits="NewsLetter.CustomizeTemplate"
    CodeBehind="CustomizeTemplate.aspx.cs" %>
    ...
    <div>
        <table class="tableContainer">
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfTN" runat="server" ControlToValidate="txtTemplateName"
                        ...
                        ValidationGroup="CustomizeTemplate">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="regexFromAddress" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                        ...
                        ValidationGroup="CustomizeTemplate"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSaveAndProceed" CssClass="frmButton" ValidationGroup="CustomizeTemplate"
                        Text="Proceed" runat="server" OnClick="btnSaveAndProceed_Click"></asp:Button>
                    &nbsp;
                    <asp:Button ID="btnSave" Text="Save" CssClass="frmButton" ValidationGroup="CustomizeTemplate"
                        runat="server" OnClick="btnSave_Click"></asp:Button>
                    &nbsp;
