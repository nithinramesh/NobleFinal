<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuotationEdit.ascx.cs"
    Inherits="Noble.Quotation.QuotationEdit" %>
        ...
        <td>
            <table id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtQuotNo" runat="server" ReadOnly="true" Visible="false" Text='<%# DataBinder.Eval( Container, "DataItem.QuotNo"  ) %>'>
                        </asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAddress" CssClass="frmBox" runat="server" TextMode="MultiLine" Text='<%# DataBinder.Eval( Container, "DataItem.Address") %>'
                            TabIndex="2">
                        </asp:TextBox>
...
<table style="background-color: #DAE2E8;">
    <tr>
        <td>
        </td>
        <td>
            ...
            <telerik:RadGrid ID="gvQuotDetails" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                Skin="WebBlue" OnDeleteCommand="gvQuotDetails_DeleteCommand">
                <MasterTableView Width="800px" EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="ID">
                    
                    <EditFormSettings>
                        <PopUpSettings Width="500px" Height="300px" Modal="true"/>
                    </EditFormSettings>
                    <Columns>
                    ...
                    <EditFormSettings UserControlName="AddQuotationDetails.ascx" EditFormType="WebUserControl" CaptionFormatString="Add Products">
...
<table style="padding-top: 30px; background-color: #fff;" width="800px">
    <tr>
        <td align="center">
